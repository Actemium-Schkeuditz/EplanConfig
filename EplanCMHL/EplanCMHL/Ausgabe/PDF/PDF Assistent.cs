...
sAusgabeOrdner = sProjektOrdner + "\\DOC";
break;
...
sAusgabeOrdner = sAusgabeOrdner.Replace(@"C:\Daten\Eplan", "L:");	//Hier anpassen, welche Laufwerksbuchstaben verwendet werden.
break;
...
{
sDateiName += "_" + DateTime.Now.ToString("HHmm"); ;
}
